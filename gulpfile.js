...
gulp.task('rename', function ()  {
    ...
    if (!newname) {
        console.log('Please write the new gofarmtech name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/gofarmtech.png')) {
        fs.renameSync(__dirname + '/admin/gofarmtech.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/gofarmtech.html')) {
        fs.renameSync(__dirname + '/widgets/gofarmtech.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/gofarmtech/js/gofarmtech.js')) {
        fs.renameSync(__dirname + '/widgets/gofarmtech/js/gofarmtech.js', __dirname + '/widgets/gofarmtech/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/gofarmtech')) {
        fs.renameSync(__dirname + '/widgets/gofarmtech',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /gofarmtech/g,
        ...
        {
            match: /Gofarmtech/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Gofarmtech'
        },
        {
            match: /@@Author@@/g,
            replacement: author
